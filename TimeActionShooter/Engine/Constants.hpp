...
enum AIMovementPattern
{
	AIMOVEMENTPATTERN_LEFTTORIGHT,
	AIMOVEMENTPATTERN_RIGHTTOLEFT,
	AIMOVEMENTPATTERN_DOWN,
	AIMOVEMENTPATTERN_STILL,
	AIMOVEMENTPATTERN_DESTINATION,
	NUM_AIMOVEMENTPATTERN
};
